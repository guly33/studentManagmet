					...
					<div class="col-6">
						...
						<div class="studentsNavContainer">
							<nav class="nav flex-column studentsNav" id="students">
								...
								<div class="alert alert-success" id="removeStudentSucsses" role="alert">
									נמחק בהצלחה!
								</div>
		...
		<div class="col-8">
			<div class="controlDivContainer">
				<div class="addStudent controlDiv" >
					<form action="includes/handlers/addStudentHandler.php" method="post" enctype="multipart/form-data">
						...
						<button type="submit" class="btn btn-primary submitBtn" name="submit" value="addStudent">הוסף</button>
					</form>
				</div>
				<div class="addCourse controlDiv">
					<form action="includes/handlers/addCourseHandler.php" method="post"  enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="courseName" name="courseName" placeholder="הכנס שם קורס.">
						</div>
						<div class="form-group">
							<label for="description">תיאור:</label>
							<br>
							<textarea name="description" class="styled" onfocus="this.value='';">הכנס תיאור קורס כאן</textarea>
						</div>
